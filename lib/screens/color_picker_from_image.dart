                  ...
                  child: BlocBuilder<ColorPickerBloc, ColorPickerState>(
                        ...
                        child: Column(
                          ...
                          children: [
                            Stack(children: [
                              GestureDetector(
                                onTapDown: (details) {
                                  context.read<ColorPickerBloc>().add(ColorPickedEvent(
                                      image,
                    ...
                    return SingleChildScrollView(
                      ...
                      child: GestureDetector(
                        onTapDown: (details) {
                          context.read<ColorPickerBloc>().add(ColorPickedEvent(
                              image, details.localPosition, _scrollController, context));
                        },
                        child: Image.file(image),
                      ),
                    );
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Pick A Color", style: const TextStyle(fontWeight: FontWeight.bold),),
                SizedBox(width: 20,),
              ],
            ),
          ),
